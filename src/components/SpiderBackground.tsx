  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      particles.push({
        ...
        color: "rgba(244, 223, 200, 0.35)", // Warm Luxury Beige #F4DFC8
      });
    }
    ...
    const draw = () => {
      // Clear with micro transparency to create extremely soft trace effect
      ...
      gradient.addColorStop(0, "rgba(20, 15, 10, 0.45)"); // Soft elegant luxury gold undertone
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 130) {
            ...
            ctx.strokeStyle = `rgba(244, 223, 200, ${alpha})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
        ...
        if (mouse.x > -500) {
          ...
          if (dist < mouse.radius) {
            ...
            // Bright luxury golden synaptical link for cursor pointer response
